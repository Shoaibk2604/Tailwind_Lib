...
const MegaMenuPage = () => {
  const codeSyntax = `import React, { useState } from "react";
              ...
              <ul className="flex flex-col mt-4 font-medium md:flex-row md:space-x-8 md:mt-0">
                ...
                <li>
                  ...
                  <div
                    ...
                    className={dropDown?"absolute z-10 grid block w-auto grid-cols-2 text-sm bg-white border border-gray-100 rounded-lg shadow-md dark:border-gray-700 md:grid-cols-3 dark:bg-gray-700":"absolute z-10 grid hidden w-auto grid-cols-2 text-sm bg-white border border-gray-100 rounded-lg shadow-md dark:border-gray-700 md:grid-cols-3 dark:bg-gray-700"}
                  >
