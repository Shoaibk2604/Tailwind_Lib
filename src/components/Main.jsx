    ...
    <div className="bg-main z-19">
      ...
      <div className="border-b-[2px] border-gray-700 mx-8 py-6">
        ...
        <p className="text-xl font-semibold text-slate-400 py-2">
          ...
          Tailwind CSS and vanilla JavaScript with support for TypeScript.
        </p>
      </div>
      <div className="border-b-[2px] border-gray-700 mx-8 py-6">
        <h2 className="text-3xl font-semibold text-slate-50">Using Flowbite</h2>
        <p className="text-xl font-semibold text-slate-400 py-2">
          ...
          hard to quickly prototype a user interface.<br/> This is where Flowbite
          comes into play: it’s basically Tailwind CSS, but you get all of the
          components that you would normally get with a classic CSS framework
          like Bootstrap or Bulma.
        </p>
      </div>
    </div>
  );
